...
int main(int argc, char *argv[]){
    ...
    printf("Endereço local é: ");
    char address_buffer2[100];
    char service_buffer2[100];
    getnameinfo(hints.ai_addr, hints.ai_addrlen, address_buffer2, sizeof(address_buffer2),
    service_buffer2, sizeof(service_buffer2), NI_NUMERICHOST);

    printf("%s %s\n", address_buffer2, service_buffer2);
